...
$row = mysqli_fetch_array($result);
    ?>
        ...
        <label for="cat_id" style="display: block; margin-top: 10px;">Category:</label>
        <select id="cat_id" name="ccc_product[cat_id]" style="width: 100%; padding: 8px; margin-top: 5px; margin-bottom: 15px; box-sizing: border-box;">
